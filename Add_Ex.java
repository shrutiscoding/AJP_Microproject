...
public class Add_Ex extends JFrame implements ActionListener {
    ...
    public void setup() {
        ...
        l1 = new JLabel("Extra Curricular Activity Record Insertion Form");
    ...
    public void actionPerformed(ActionEvent ae)
	{
        ...
        String numberOfBeneficiaries = lben.getText();
                    ...
                    try 
					{
						...
						String insertSQL = "INSERT INTO activities (year, datel, timel, place, t_coordinator, hod, s_coordinator, topic, name, details, beneficiaries) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
