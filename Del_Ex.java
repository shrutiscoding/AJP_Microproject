...
public class Del_Ex extends JFrame implements ActionListener {
    ...
    public void setup() {
        ...
        l1 = new JLabel("Extra Curricular Activity Record Deletion Form");
		  ...
		  try 
					{
						...
						String deleteSQL = "Delete from activities where topic=?";
