...
public class Extra_Info extends JFrame implements ActionListener {

    JButton b1, b2, b3,b4,b5;
    JLabel l1;

    public Extra_Info() {
        super("Extra Curricular Activity Management System");
        setup();
	...
	JLabel imageLabel = new JLabel(new ImageIcon("f.jpg"));
        ...
        l1 = new JLabel("Extra Curricular Activity Management System");
