...
public class Mod_Co extends JFrame implements ActionListener {
    ...
    public void setup() {
        ...
        l1 = new JLabel("Co Curricular Activity Record Updation Form");
    ...
    public void actionPerformed(ActionEvent ae)
	{
		...
		Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/microp","root","");   
						String updateSQL = "UPDATE co_activities SET year=?, datel=?, timel=?, place=?, t_coordinator=?, S_coordinator=?, topic=?, name=?, details=?, beneficiaries=? WHERE topic = ?";
